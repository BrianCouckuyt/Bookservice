...
namespace Bookservice.WebAPI.Data
{
    public class BookServiceContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Publisher>().ToTable("Publisher").HasData(
                new Publisher(1, "IT-Publishers","UK"),
                new Publisher(2, "FootBooks", "Sweden")
                );

            modelBuilder.Entity<Author>().ToTable("Author").HasData(
                new Author(1,"Patrick","Rothfuss",new DateTime(1980 , 5, 20)),
                new Author(1, "Brandon", "Sanders", new DateTime(1980, 5, 20)),
                new Author(1, "Jim", "Butcher", new DateTime(1996, 8, 12))
                );
